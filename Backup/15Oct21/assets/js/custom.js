 ...
 // Function for "Add Specific Delivery Dates" under Delivery Days & Specific Delivery Dates
    ...
    $(".add-more-weekday").click(function(){
        ...
        var row = '<tr>' +
            ...
            '<td><select class="ib-small" name="weekday" id="weekday-same-day-cutoff"><option value="300pM">3:00 PM</option><option value="330pm">3:30 PM</option><option value="400pm">4:00 PM </option><option value="430pm">4:30 PM </option><option value="500pm">5:00 PM  </option><option value="350pm">5:00 PM</option></select></td>' +
            '<td><select class="ib-small" name="next-day-cut-off" id="next-day-cut-off"><option value="300pM">3:00 PM</option><option value="330pm">3:30 PM</option><option value="400pm">4:00 PM </option><option value="430pm">4:30 PM </option><option value="500pm">5:00 PM  </option><option value="350pm">5:00 PM</option></select></td>' +
    ...
    $(".add-time-slote-onb4").click(function(){
        ...
        var index = $("table tbody tr:last-child").index();
        var row = '<tr>' +
            '<td><div class="el-checkbox el-checkbox-green d-uni-col"><input type="checkbox" id="cb_opt_nm_20" value="cb_opt_val_20" checked><label class="el-checkbox-style mb-0" for="cb_opt_nm_20"></label> <span><input type="date" class="form-control ib-small w-75 ml-1" name="holiday-name" placeholder="Enter Holiday" id="date-slote"></span></div></td>' +
            '<td><select class="ib-small" name="min-time" id="mintime"><option value="9:00 AM - 10:00AM">9:00 AM - 10:00AM</option><option value="10:30 AM - 11:45 AM">10:30 AM - 11:45 AM</option><option value="3">12:30 AM - 01:45 PM</option><option value="10:15 AM - 12:45 AM">10:15 AM - 12:45 AM</option><option value="08:15 AM - 10:45 AM">08:15 AM - 10:45 AM</option></select></td>' +
            '<td><select class="ib-small" name="min-time" id="mintime"><option value="1">1</option><option value="2">2</option><option value="3">3 </option><option value="4">4</option><option value="5">5 </option><option value="6">6</option><option value="7">7</option></select></td>' +
   ...
   $(".add_pickup_location").click(function(){
    ...
    $(document).on("click", ".add", function(){
        var empty = false;
        var input = $(this).parents("tr").find('input[type="date"],input[type="text"],select');
            console.log(input);
            $(".add").hide();
            $(".edit").show();
    ...
    $(document).on("click", ".add-new", function(){
        var empty = false;
        var input = $(this).parents("tr").find('input[type="text"],select,input[type="date"]');
        input.each(function(){
            if(!$(this).val()){
                $(this).add_del_schClass("error");
                empty = true;
...
$(document).on("click", ".weekdays-sch-edit", function(){        
    ...
    $(this).parents("tr").find("td:eq(1)").each(function(){
        $(this).html('<select class="ib-small" name="next-day-cut-off" id="next-day-cut-off"><option value="3:00 PM">3:00 PM</option><option value="3:30 PM">3:30 PM</option><option value="4:00 PM ">4:00 PM </option><option value="4:30 PM">4:30 PM </option><option value="5:00 PM">5:00 PM  </option><option value="5:00 PM">5:00 PM</option></select>');
    });
    ...
    $(this).parents("tr").find("td:eq(5)").each(function(){
        $(this).html('<select class="ib-small" name="weekday" id="min-time"><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option></select>');
    });
...
$(document).on("click", ".time-slote-edit", function(){        
    ...
    $(this).parents("tr").find("td:eq(2)").each(function(){
        $(this).html('<select class="ib-small" name="min-time" id="mintime"><option value="9:00 AM - 10:00AM">9:00 AM - 10:00AM</option><option value="10:30 AM - 11:45 AM">10:30 AM - 11:45 AM</option><option value="3">12:30 AM - 01:45 PM</option><option value="10:15 AM - 12:45 AM">10:15 AM - 12:45 AM</option><option value="08:15 AM - 10:45 AM">08:15 AM - 10:45 AM</option></select>');
    });
    $(this).parents("tr").find("td:eq(3)").each(function(){
        $(this).html('<input type="text" class="form-control ib-small" name="holiday-name" placeholder="Time Slot" id="time-slote" value="3">');
    });
    $(this).parents("tr").find("td:eq(4)").each(function(){
        $(this).html('<input type="text" class="form-control ib-small" name="holiday-name" placeholder="$" id="time-slote" value="$2">');
    });
    $(this).parents("tr").find("td:eq(5)").each(function(){
